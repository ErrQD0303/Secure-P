...
public class GetAppUserParkingSubscriptionDto<TKey> where TKey : IEquatable<TKey>
{
    [JsonPropertyName("id")]
    ...
    public virtual GetAppUserParkingSubscriptionParkingZoneDto<TKey> ParkingZone { get; set; } = default!;
